...
import './Footer.css';
import { FaInstagram, FaGithub, FaLinkedin, FaBlog } from 'react-icons/fa';
...
export default function Footer() {
    return (
        <footer>
            ...
            <a href="https://www.linkedin.com/in/%EC%9A%94%ED%95%9C-%EC%95%88-b64a53315/?trk=opento_sprofile_topcard" target="_blank" rel="noopener noreferrer">
                <FaLinkedin /> 
            </a>
